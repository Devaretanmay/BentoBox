...
Implements a :class:`CompartCodeExecutor` that satisfies AutoGen's
...
kernel-enforced :class:`compart.AgentCompart` compartment. This replaces
AutoGen's default ``LocalCommandLineCodeExecutor`` / Docker executor with
Compart isolation: deny-by-default filesystem, blocked network, and BLAKE3
...
class CompartCodeExecutor:
    """Execute AutoGen code blocks inside a Compart compartment.
