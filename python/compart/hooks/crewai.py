...
Provides a :class:`CompartCodeInterpreterTool` that plugs into CrewAI agents
in place of the Docker-based ``CodeInterpreterTool``. The agent-supplied
Python code runs inside a kernel-enforced
:class:`compart.AgentCompart` compartment: deny-by-default filesystem,
...
class CompartCodeInterpreterTool(_CrewaiBaseTool):  # type: ignore[misc]
    """CrewAI-compatible tool that runs Python inside a Compart sandbox.
    ...
    name: str = "compart_code_interpreter"
    description: str = (
...
class CrewAICodeExecutor:
    ...
    Wraps :class:`~compart.hooks.base.SandboxRunner` behind a small
    ...
    def execute(self, code: str, language: str = "python") -> Dict[str, Any]:
        ...
        -------
        dict[str, Any]
            :meth:`~compart.hooks.base.ExecutionResult.as_dict` payload.
        """
